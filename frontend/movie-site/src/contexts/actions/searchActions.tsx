...
async function getSearchData(dispatch:React.Dispatch<any>, searchQuery:string, searchFilter:number) {
  try {
...
const getActorData = async function (input:string) {
...
const getMovieData = async function (input:string) {
